...
Comprehensive sample sheet from nextflow round 2 (/data/project/MillerLab/projects/mNSC/250730_mNSC_nf-core)
...
Files copied into the *input* folder

```{r}

readRenviron("/data/250805_mNSC_EDA/.Renviron")
